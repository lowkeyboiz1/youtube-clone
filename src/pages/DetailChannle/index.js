    ...
    <div className='wrapper'>
      ...
      <div className='info-channle lg:flex px-[10px] md:px-[60px] justify-between mt-[24px]'>
        <div className='warpper-info-channle md:flex text-center md:text-left'>
          <div className='ava-channle mx-auto md:mx-0 w-[50px] h-[50px] md:w-[128px] md:h-[128px] rounded-full overflow-hidden flex-shrink-0'>
            {dataVideoChannle ? (
              <img
          ...
          {dataVideoChannle ? (
            <div className='info-channle-detail flex flex-col justify-center ml-[24px]'>
