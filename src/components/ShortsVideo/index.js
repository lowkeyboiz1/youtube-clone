...
function ShortsVideoItem({urlVideo, titleVideo, titleChannle, urlChannleImg, like, comment}) {
  ...
  const handleDuration = (duration) => {
    // Xử lý độ dài video ở đây
    console.log("Độ dài video:", duration);
  };
  ...
  return (
    <div className="flex snap-start justify-center mb-[56px] md:mb-[5vh] h-[calc(100vh_-_56px)] md:mt-[5vh] md:h-auto relative md:static">
      <div className="video md:w-[315px] w-full h-full md:h-[86vh] rounded-[8px] relative">
        <div
          className="reactplayerVideo object-cover w-full h-full"
        ...
        <div className="video-info absolute bottom-[10px] md:bottom-[16px] right-0 left-0 md:px-[10px] pl-[10px] pr-[64px] flex flex-col">
          ...
          <div className="info-channel flex items-center md:gap-0 md:justify-between order-1 md:order-2">
            <div className="flex items-center gap-2">
              ...
              <div className="username text-[12px] md:text-[14px]">{titleChannle}</div>
            </div>
